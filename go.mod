module terraform-provider-zenduty

go 1.17

require (
	github.com/Kdheeru12/zenduty-test v0.1.0
...
require (
	...
	github.com/hashicorp-demoapp/hashicups-client-go v0.0.0-20210721190446-1df90c457bd4 // indirect
